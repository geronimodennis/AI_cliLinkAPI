...
export class ToolSessions<T> {
  ...
  put(input: Generation, value: T, name: string, args: unknown): ToolCall {
    if (this.entries.size >= this.limit) throw new CliLinkAPIError(429, 'pending_tool_limit', 'Too many pending tool continuations.');
